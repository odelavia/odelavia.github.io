                  ...
                  <div className="yui-u">
                    ...
                    <div className="job">
                      ...
                      <div className="spacing">
                        <i>A global collaboration platform and coding-cohort generator. They connect motivated learners with shared goals to learn, help and build together.</i>
                      </div>
                    ...
                    <div className="job">
                      ...
                      <div className="spacing">
                        <i>A Boutique art gallery based in Vienna, Virginia.</i>
                      </div>
                ...
                <div className="yui-gf">
                  <div className="yui-u">
                    ...
                    <div className="job last">
                      ...
                      <div className="spacing">
                        <i>Residential/commercial contracting company that renovates spaces in the Washington D.C. area.</i>
                      </div>
